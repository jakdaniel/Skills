...
3. **Nomenclature Sémantique et Structurée :** Déclarer des variables CSS explicites, réutilisables et cohérentes dans `:root` (dans `ThemeProvider.svelte` et `src/app.css`).
...
### 5. Polices et Tailles de Texte (`--font-*`, `--font-size-*`)
*   **Format :** `--font-[usage]` ou `--font-size-[niveau]`
*   **Obligation :** Ne jamais inscrire de `font-family` brute (ex: `'Inter'`, `Arial`) ni de `font-size` brute (ex: `14px`, `2.3rem`) dans les composants. Utiliser systématiquement :
    *   `font-family: var(--font-heading);` (Titres sérif Playfair Display)
    *   `font-family: var(--font-body);` (Texte principal Roboto)
    *   `font-family: var(--font-number);` (Chiffres & Counters Montserrat)
    *   `font-size: var(--font-size-title-page);` (2.3rem)
    *   `font-size: var(--font-size-title-modal);` (1.5rem)
    *   `font-size: var(--font-size-base);` (16px / 14px)
    *   `font-size: var(--font-size-md);` (0.95rem)
    *   `font-size: var(--font-size-sm);` (0.9rem)
    *   `font-size: var(--font-size-xs);` (0.8rem)
    *   `font-size: var(--font-size-xxs);` (0.7rem)
    *   `font-size: var(--font-size-badge);` (0.78rem)
...
| :--- | :--- | :--- |
| `font-family: 'Playfair Display', serif;` | `font-family: var(--font-heading);` | `--font-heading: 'Playfair Display', serif;` |
| `font-size: 2.3rem;` | `font-size: var(--font-size-title-page);` | `--font-size-title-page: 2.3rem;` |
| `font-size: 1.5rem;` | `font-size: var(--font-size-title-modal);` | `--font-size-title-modal: 1.5rem;` |
| `font-size: 14px;` | `font-size: var(--font-size-sm);` | `--font-size-sm: 0.9rem;` |
