...
**IMPORTANT** Utiliser conjointement avec le sous-skill [`testing-playwright`](./testing-playwright/SKILL.md).
...
- Des tests de logique métier simple (ex: calcul de prix) → [`testing-unit`](./testing-unit/SKILL.md).
- Couvrir 100% des cas d'erreur API → [`testing-integration`](./testing-integration/SKILL.md).
