---
name: git-sync
description: Workflow Git sécurisé, incluant la synchronisation et le respect des branches.
---
...
## 4. Déploiement
- Le déploiement vers la production s'effectue uniquement après validation et fusion via une Pull Request (gérée côté utilisateur ou sur demande spécifique).
